...
def parse_args():
    ...
    parser.add_argument('--source_model', type=str, default='pt-imdb_model__epoch10_lr0.0001_data25000', help='Pre-trained model name')
...
def main():
    ...
    # Log file setup
    log_file = 'transfer_imdb2amazon_log_epoch10_lr1e-4.txt'
    ...
    for epoch, lr in itertools.product(epochs, learning_rates):
        ...
        model.save_pretrained(f"pt-transfer_imdb2amazon__epoch{epoch}_lr{lr}_data{args.num_train}")
