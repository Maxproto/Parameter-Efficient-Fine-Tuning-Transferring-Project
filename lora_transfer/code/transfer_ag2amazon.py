...
def parse_args():
    ...
    parser.add_argument('--source_model', type=str, default='lora-ag_news_model__epoch3_lr0.0001_data-1', help='Pre-trained model name')
...
def main():
    ...
    # Log file setup
    log_file = 'transfer_ag2amazon_log_epoch5_lr1e-4.txt'
    ...
    for epoch, lr in itertools.product(epochs, learning_rates):
        ...
        model.save_pretrained(f"lora-transfer_ag2amazon__epoch{epoch}_lr{lr}_data{args.num_train}")
